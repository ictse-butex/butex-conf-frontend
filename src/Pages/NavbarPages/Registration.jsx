            ...
            {(registrationEndDate > today) ?
                (<div className='bg-white'>
                    <div className={`bg-white ${accepted ? 'hide' : 'show'}` }>
                        ...
                        <p className='text-center mb-3 pb-5 text-gray-500 dark:text-gray-400'>Last date of registration is <b>20 May 2024.</b></p>
                ...
                (
                    <div className='text-center bg-red-300 p-3'>
                        Sorry. Registration deadline exceeded.
                    </div>
                )
            }
        </>
